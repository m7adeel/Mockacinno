...
export default function TargetProfession() {
  ...
  return (
    <View className="flex-1 bg-gray-50 pt-14 px-4">
      ...
      <View className="flex-row items-center mb-4">
        ...
        <Text className="text-lg font-semibold ml-4">Select your <Text className="font-bold">Target Role</Text></Text>
      </View>
      ...
      {/* Continue Button */}
      <Pressable className="absolute bottom-8 self-center w-[90%] py-4 bg-blue-700 rounded-full shadow-md">
