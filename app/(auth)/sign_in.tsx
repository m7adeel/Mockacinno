...
export default function SignIn() {
    ...
    return (
        <SafeAreaView className='flex-1 bg-[#F3F3F3] items-center px-10'>
            ...
            <TouchableOpacity className='bg-[#2934D0] w-full py-3 rounded-full mt-5' onPress={() => {
                if (email && password) {
            ...
            <TouchableOpacity onPress={() => { router.push('/(auth)/sign_up') }} className='absolute bottom-10'>
                <Text className='text-[#B6B6B6] w-full text-center font-light mt-5'>Don't have an account? <Text className='text-[#2934D0]'>Sign Up</Text></Text>
            </TouchableOpacity>
        </SafeAreaView>
    )
}